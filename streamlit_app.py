...
# =================================================================
# ⚙️ IEKŠĒJIE KONFIGURĀCIJAS PARAMETRI (Nav redzami lietotnē)
# =================================================================
...
if usage > 0:
    ...
    # --- 3. REZULTĀTU CILNES ---
    tab1, tab2 = st.tabs(["📋 Piedāvājuma Kopsavilkums", "⚖️ Salīdzinājums: Neko nedarīt vs ESTACIJA"])
    ...
    with tab2:
        ...
        st.error(f"**Neinvestējot šodien, Jūsu zaudējumi pēc 20 gadiem būs: {n_data[-1] - s_data[-1]:,.0f} €**")
